        ...
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
            <div>
              ...
              <p style={{ color: '#718096' }}>Manage customer testimonials</p>
            </div>
            <button
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ background: '#f7fafc', borderBottom: '1px solid #e2e8f0' }}>
                    ...
                    <th style={{ padding: '16px', textAlign: 'left', fontSize: '14px', fontWeight: '600', color: '#2d3748' }}>Content</th>
                    <th style={{ padding: '16px', textAlign: 'center', fontSize: '14px', fontWeight: '600', color: '#2d3748' }}>Rating</th>
                  ...
                  {testimonials.length === 0 ? (
                    ...
                    testimonials.map((testimonial) => (
                      <tr key={testimonial.id} style={{ borderBottom: '1px solid #e2e8f0' }}>
                        <td style={{ padding: '16px', fontWeight: '500', color: '#2d3748' }}>{testimonial.name}</td>
                        <td style={{ padding: '16px', color: '#718096', maxWidth: '300px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                          {testimonial.content}
                        </td>
                        <td style={{ padding: '16px', textAlign: 'center', color: '#718096' }}>
                        ...
                        <td style={{ padding: '16px', textAlign: 'center' }}>
                          <span style={{
                            ...
                            fontSize: '12px',
                            fontWeight: '600',
                            background: testimonial.is_active ? '#c6f6d5' : '#fed7d7',
                            color: testimonial.is_active ? '#22543d' : '#742a2a'
                          }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: '20px' }}>
                  <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600', color: '#2d3748' }}>Testimonial *</label>
                  <textarea
                ...
                <div style={{ marginBottom: '20px' }}>
                  ...
                  <input
                    ...
                    placeholder="/assets/testimonials/customer.jpg"
                    style={{
                      width: '100%',
                      padding: '12px',
                      border: '1px solid #e2e8f0',
                ...
                <div style={{ marginBottom: '20px' }}>
                  <label style={{ display: 'block', marginBottom: '8px', fontWeight: '600', color: '#2d3748' }}>Rating (1-5)</label>
                  <input
                    type="number"
                    min="1"
                    max="5"
