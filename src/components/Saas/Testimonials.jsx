    ...
    <section className="testimonials section-padding bg-gray5 style-5" data-scroll-index="5">
      <div className="container">
        <div className="section-head text-center mb-60 style-5">
          ...
          <p>{ rtl ? 'لقد أحببت HighwayAuto من آلاف العملاء في جميع أنحاء العالم وحصلت على ثقة من الشركات الكبرى.' : 'Highway Autosolutions is loved by thoudsands of customer and is trusted.' }</p>
        </div>
      </div>
          ...
          >
            {
              testimonialsData.map((testimonial, i) => (
                <SwiperSlide key={i}>
                  <a className="testi-card style-5">
                    <div className="stars">
