          ...
          <div className="col-lg-4">
            <div className="info">
              <div className="section-head mb-30 style-5">
                <h2>{ rtl ? '' : 'Why' } <span>{ rtl ? 'خدماتنا' : 'Choose Us' }</span> </h2>
              </div>
              <div className="text mb-50 fs-12px color-666">
                { rtl ? 'مع سوق HighwayAuto ، اختر من بين مئات بوابات الدفع لعملائك.' : 'With Highway Autosolutions, you are guaranteed: .' }
              </div>
              <ul>
                {
              ...
              <Link href={ rtl ? "/rtl-page-services" : "/services" }>
                <a className="btn rounded-pill blue5-3Dbutn hover-blue2 sm-butn fw-bold mt-60 px-5">
                  <span>{ rtl ? 'مشاهدة المزيد' : 'Explore Our Services' }</span>
                </a>
              </Link>
            </div>
          </div>
